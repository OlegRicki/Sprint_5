...
class TestConstruction(TestBase):
    ...
    def test_open_buns_sections(self, driver, authorization):
        ...
        self.click_to_element(wait, locator=MainPage.SAUCES_BUTTON)
        self.click_to_element(wait, locator=MainPage.BUNS_BUTTON)
    ...
    def test_open_fillings_sections(self, driver, authorization):
        wait = WebDriverWait(driver, 10)
        self.click_to_element(wait, locator=MainPage.FILLING_BUTTON)
